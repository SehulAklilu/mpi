...
import { ICountry } from "country-state-city"; // Assuming you only need ICountry from this import

interface DropdownProps {
  label: string;
  options: ICountry[];
  selected: ICountry | string | undefined;
  setSelected: (value: ICountry | undefined) => void;
  name: string;
...
const DropdownCountry: FC<DropdownProps> = ({
  label,
  options,
  selected,
  setSelected,
