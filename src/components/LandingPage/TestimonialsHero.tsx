...
function TestimonialsHero() {
  return (
    <div className="w-full  sm:h-screen bg-[#EFEFED] relative">
      <LandingPageNavBar />
      <div className="container my-auto mx-auto px-4 sm:px-10 flex items-center min-h-[80Vh] mt-2 md:mt-4 xl:mt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-[#152946]  items-center md:my-4 lg:my-6 xl:my-10">
            <div className="space-y-8 sm:space-y-4 text-center w-full md:w-[80%]  md:text-left">
              ...
              <p className="text-xs sm:text-base">
                ...
                nisl non arcu gravida euismod. Nullam felis dui,
              </p>
